...
const MobileNav = ({mobileNav, setMobileNav}) => {
    return ( 
        <motion.nav 
            className='text-white h-screen w-full top-0 z-80 fixed bg-black flex flex-col items-center justify-between pt-3.5'
            initial={{scale: 0}} animate={{scale: [0, 1.5, 1]}} transition={{duration: 1, ease:'easeIn'}}  exit={{scale: 0, opacity:0}} >
                ...
                <div className='rounded-md p-4 w-5/6 flex justify-center items-center gap-3 overflow-auto bg-secondary-200 bg-opacity-50 mb-14'>
