...
const Header = () => {
    ...
    return (
        <div className="pt-3.5 fixed w-full z-50"> 
            <header className="flex justify-between items-center w-3/4 mx-auto py-1 px-2 text-sm rounded-md text-secondary-100 bg-secondary-200 bg-opacity-90 " data-aos='zoom-out' data-aos-duration='500' data-aos-delay='600'>
