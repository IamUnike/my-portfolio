    ...
    return ( 
        <motion.nav 
            ...
            initial={{scale: 0}} animate={{scale: [0, 2, .7, 1]}} transition={{duration: 1, ease:'easeIn'}}  exit={{scale: 0, opacity:0}} >
                ...
                <div className='bg-secondary-200 rounded-md p-2 flex justify-between w-4/5  items-center'>
                ...
                <div className='p-4 w-4/5 flex justify-center items-center gap-4'>
                ...
                <div className='rounded-md p-4 w-4/5 flex justify-center items-center gap-3 overflow-auto bg-secondary-200 bg-opacity-50'>
