        ...
        <div>
            <section className="w-5/6 h-fit mx-auto mt-6 ">
                ...
                <div className=" text-white" data-aos='slide-up' data-aos-duration='500'>
                    ...
                    <li className="li"> I have keen interest in <span className="bg-purple-800"> building secure, fast and reliable web applications and sites </span> by employing best practices</li>

                    <li className="li"> I use my knowledge of <span className="bg-purple-800"> Data structure and Algorithms </span> to help me build the website you've modelled in your mind </li>

                    <li className="li"> As I write codes, I also consider the inter-twined relationship between users and web interfaces. Hence, my expertise in <span className="bg-purple-800"> Human Computer Interactions(HCI) </span> </li>
                </div>
